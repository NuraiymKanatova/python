# to create date, we can use the datetime() class (constructor) of the datetime module
# the datetmie() class requires three parameters to create a date: year, month, day.
